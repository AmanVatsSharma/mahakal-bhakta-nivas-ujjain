...
export const ROOMS = [
	{
		id: '2-bed-room-non-ac',
		name: '2 Bed Room (Non-AC)',
		slug: '2-bed-room-non-ac',
		price: 1250,
		priceText: '₹1,250',
		capacity: '2 guests',
		size: '14 sq.m',
		image: '/rooms/2BedRoomNonAC1250.jpeg',
		imageAlt: '2 Bed Non-AC Room at Mahakal Bhakta Nivas',
		description: 'Comfortable non-AC room with 2 clean beds — the most affordable way to stay near Mahakaleshwar Temple. Bright, airy, and perfect for pilgrims on a budget.',
		features: ['2 comfortable beds', 'Attached bathroom', 'Hot water', 'Ceiling fan', '24/7 power backup'],
	...
	},
	{
		...
		capacity: '2 guests',
		size: '14 sq.m',
		image: '/rooms/2BedRoomAC1650.jpeg',
		imageAlt: '2 Bed AC Room at Mahakal Bhakta Nivas Ujjain',
		description: 'Air-conditioned room with 2 comfortable beds and an attached bathroom. Ideal for couples and friends who want cool comfort after a day of darshan.',
		features: ['2 comfortable beds', 'Air conditioning', 'Attached bathroom', 'Hot water', '24/7 power backup'],
		badge: 'Best Value',
	},
	{
		id: '3-bed-room-non-ac',
		name: '3 Bed Room (Non-AC)',
		slug: '3-bed-room-non-ac',
		price: 1785,
		priceText: '₹1,785',
		capacity: '3 guests',
		size: '18 sq.m',
		image: '/rooms/3BedRoomNonAC1785.jpeg',
		imageAlt: '3 Bed Non-AC Room at Mahakal Bhakta Nivas',
		description: 'Spacious non-AC room with 3 clean beds — great for small families or groups of devotees travelling together on a budget.',
		features: ['3 comfortable beds', 'Attached bathroom', 'Hot water', 'Ceiling fan', '24/7 power backup'],
		badge: null,
	},
	{
		id: '3-bed-room-ac',
		...
		capacity: '3 guests',
		size: '18 sq.m',
		image: '/rooms/3BedRoomAC2050.jpeg',
		imageAlt: '3 Bed AC Room at Mahakal Bhakta Nivas',
		description: 'Air-conditioned room with 3 comfortable beds and an attached bathroom. A favourite with families visiting Mahakaleshwar together.',
		features: ['3 comfortable beds', 'Air conditioning', 'Attached bathroom', 'Hot water', '24/7 power backup'],
		badge: null,
	},
	{
		id: '4-bed-room-non-ac',
		name: '4 Bed Room (Non-AC)',
		slug: '4-bed-room-non-ac',
		price: 2100,
		priceText: '₹2,100',
		capacity: '4 guests',
		size: '22 sq.m',
		image: '/rooms/4BedRoomNonAC2100.jpeg',
		imageAlt: '4 Bed Non-AC Room at Mahakal Bhakta Nivas',
		description: 'Large non-AC room with 4 clean beds — ideal for bigger families and groups who want to stay together near the temple.',
		features: ['4 comfortable beds', 'Attached bathroom', 'Hot water', 'Ceiling fan', '24/7 power backup'],
	...
	},
	{
		...
		capacity: '2-3 guests',
		size: '16 sq.m',
		image: '/rooms/Deluxe2450.jpeg',
		imageAlt: 'Deluxe Room with king bed and AC at Mahakal Bhakta Nivas',
		description: 'Well-appointed deluxe room with a king-size bed, split AC, LED TV, and tea/coffee kettle. Premium comfort for couples and small families.',
		features: ['King-size bed', 'Air conditioning', 'LED TV', 'Tea/coffee kettle', 'Attached bathroom with geyser', 'Wardrobe & dressing area'],
		badge: 'Best Seller',
	},
	{
		id: '4-bed-room-ac',
		...
		capacity: '4 guests',
		size: '22 sq.m',
		image: '/rooms/4BedRoomAC2475.jpeg',
		imageAlt: '4 Bed AC Room at Mahakal Bhakta Nivas',
		description: 'Our largest multi-bed room — 4 comfortable beds with air conditioning and an attached bathroom. Perfect for large families on pilgrimage.',
		features: ['4 comfortable beds', 'Air conditioning', 'Attached bathroom', 'Hot water', '24/7 power backup'],
	...
	},
	{
		...
		capacity: '2-4 guests',
		size: '26 sq.m',
		image: '/rooms/DeluxeSuite3150.jpeg',
		imageAlt: 'Deluxe Suite at Mahakal Bhakta Nivas',
		description: 'Elegant suite with a large double bed, split AC, and a roomy wardrobe and dressing space. A peaceful retreat steps from Mahakaleshwar.',
		features: ['Large double bed', 'Air conditioning', 'Spacious wardrobe & dressing space', 'LED TV', 'Attached bathroom with geyser', 'Premium interiors'],
		badge: 'Premium',
	},
	{
		id: 'luxury-suite',
		...
		capacity: '2-4 guests',
		size: '30 sq.m',
		image: '/rooms/LuxurySuite4050.jpeg',
		imageAlt: 'Luxury Suite with king bed and chandelier at Mahakal Bhakta Nivas',
		description: 'Our finest suite — king-size bed with premium linen, elegant chandelier decor, and a private seating area for a truly restful pilgrimage stay.',
		features: ['King-size bed with premium linen', 'Air conditioning', 'Chandelier & elegant decor', 'Private seating area', 'Attached bathroom with geyser', '24/7 power backup'],
...
export const GALLERY_ITEMS = [
	{ id: 1, src: '/rooms/LuxurySuite4050.jpeg', alt: 'Luxury Suite at Mahakal Bhakta Nivas', category: 'rooms', featured: true },
	{ id: 2, src: '/rooms/3BedRoomAC2050.jpeg', alt: '3 Bed AC Room interior at Mahakal Bhakta Nivas', category: 'rooms' },
	...
	{ id: 9, src: '/rooms/DeluxeSuite3150.jpeg', alt: 'Deluxe Suite room at Mahakal Bhakta Nivas', category: 'rooms' },
